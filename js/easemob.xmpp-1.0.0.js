...
var uploadFn = function(options) {
    ...
    var cabbageUploadVoice = function(options) {
...
connection.prototype.open = function(options) {
	...
	var suc = function(data,xhr){
        ...
        options.user && $.cookie('im.user', innerBase64.encode(options.user));
        options.pwd && $.cookie('im.pass', innerBase64.encode(options.pwd));
...
connection.prototype.sendAudio = function(options) {
    ...
    connection.prototype.cabbageSendVoice = function(options) {
        var onerror =  options.onFileUploadError || this.onError || emptyFn;
        if(!isCanUploadFile){
            onerror({
                type : EASEMOB_XMPP_UPLOADFILE_BROWSER_ERROR,
        ...
        cabbageUploadVoice(options, this);
    };
